...
(function ($, CONFIG) {
    ...
    function extractToSet (json, key) {
        var values = {};
        var entries = Array.isArray(json) ? json : (json.pages || []).concat(json.posts || []);
    ...
    function search (json, keywords) {
        ...
        var posts = Array.isArray(json) ? json : json.posts;
    ...
    $.getJSON(CONFIG.CONTENT_URL, function (json) {
        // 兼容 searchdb 数组格式 -> 主题期望的 {path, text} 格式
        if (Array.isArray(json)) {
            json = json.map(function (item) {
                return {
                    ...
                    tags: (item.tags || []).map(function (t) { return typeof t === 'string' ? { name: t } : t; }),
                    categories: (item.categories || []).map(function (t) { return typeof t === 'string' ? { name: t } : t; })
                };
            });
        }
